...
class KeypointAttention(nn.Module):
    ...
    def forward(self, features, heatmaps):  # 11, 128, 56, 56  11, 24, 56, 56
        ...
        features = features.reshape(batch_size, -1, height*width)  # 11, 128, 3136

        attended_features = torch.matmul(normalized_heatmap, features.transpose(2,1))  # [N, js, C] 11, 24, 128  <- [N, js, H*W]11, 24, 3136  [N, H*W, C]11, 3136, 128
        # attended_features = attended_features.transpose(2,1)  # 11, 128, 24  [N. C. js]
# 
        if self.use_conv:
        ...
        return attended_features  # 11, 128, 24  [N. C. js]