...
class ChannelAttention(nn.Module):
    ...
    def forward(self, x):
        ...
        # avg_out = self.avg_pool(x)# self.fc2(self.relu1(self.fc1(self.avg_pool(x))))
        # max_out = self.max_pool(x)# self.fc2(self.relu1(self.fc1(self.max_pool(x))))
...
if __name__ == '__main__':
    img = torch.randn(1, 2048,1,1)
    net = ChannelAttention(2048)
    print(net)
    out = net(img)
    print(out.size())